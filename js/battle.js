...
function startBattle(mode){
  ...
  // ✅ ПРОВЕРКА: Если это мультиплеер — НЕ создаём ботов
  if (multiplayerMode) {
    console.log('🌐 МУЛЬТИПЛЕЕР: Ботов не создаём, ждём реальных игроков');
    updateScoreboard();
  ...
  // ✅ ОБЫЧНЫЙ БОЙ: Создаём ботов как раньше
...
function endBattle(won){
  ...
  // Завершаем мультиплеер если был
  if (multiplayerMode) {
