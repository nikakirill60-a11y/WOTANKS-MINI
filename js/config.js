const CONFIG={
  ...
  // Стоимость прокачки по уровню танка [tier] = [lvl1cost, lvl2cost]
  UPGRADE_COSTS:{
...
const GameState={
  ...
  fuelBoostActive:false,fuelBoostTimer:0,
  paiokActive:false,
  ...
  modules:{},
  // Прокачка: { tankId: { gun:0, engine:0, turret:0 } } - установленный уровень
  upgrades:{},
  // Купленные уровни: { tankId: { gun:[true,false,false], engine:..., turret:... } }
  upgradesBought:{}
};
